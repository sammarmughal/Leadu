          ...
          <div className="lg:w-1/2 text-left p-4 lg:p-8">
            <div className="mb-6">
              ...
              <ol className="list-decimal ml-5">
                <li>To be certified from any verified Religious Institute.</li>
                <li>
                ...
                <li>
                  Priority will be given to those candidates who are interested
                  in learning Quran by heart and in getting contemporary
                  education.
                </li>
          ...
          <div className="flex flex-row justify-between items-center py-20" id="row-543910648">
            ...
            <div id="col-1119556514" className="block lg:w-1/3 sm:w-full">
              <div className="col-inner flex flex-col gap-5">
                ...
                <Link  href="#"  className="button primary is-outline flex justify-center expand lead-btn rounded-full"
                >
                  <span>More info</span>
                </Link>
              </div>
